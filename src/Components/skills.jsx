...
export default function Skills() {
  return (
    <div id='skills' className="text-white p-5 pt-36 -mt-36">
      ...
      <div className="mt-6">
        <h3 className="text-gray-300 text-2xl">Languages and Tools</h3>
        <div className="flex gap-4 mt-2 text-7xl">
          ...
          <SiVite className="text-purple-400 transition transform duration-300 hover:scale-110 hover:-rotate-3" />
          <SiFigma className="text-pink-500 transition transform duration-300 hover:scale-110 hover:-rotate-3" />
        </div>
      </div>
      
      <div className="mt-6">
        <h3 className="text-gray-300 text-2xl">Libraries and Frameworks</h3>
        <div className="flex gap-4 mt-2 text-7xl">
      ...
      <div className="mt-6 flex justify-start items-center gap-20">
        <div>
          <h3 className="text-gray-300 text-2xl">Databases</h3>
          <div className="flex gap-4 mt-2 text-7xl">
        ...
        <div>
          <h3 className="text-gray-300 text-2xl">Other</h3>
          <div className="flex gap-4 mt-2 text-7xl">
